...
module AccountAvatar
  ...
  class_methods do
    def avatar_styles(file)
      ...
      styles = { original: { geometry: '400x400#', format: 'gif', file_geometry_parser: FastGeometryParser } } if file.content_type == 'image/webp'
      styles[:static] = { geometry: '400x400#', format: 'png', convert_options: '-coalesce', file_geometry_parser: FastGeometryParser } if file.content_type == 'image/gif' || file.content_type == 'image/webp'
      styles
    end
