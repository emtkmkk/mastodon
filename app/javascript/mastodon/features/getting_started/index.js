...
const messages = defineMessages({
  ...
  reactions: { id: 'navigation_bar.reactions', defaultMessage: 'Reacted posts' },
  ...
  render () {
    ...
    if (signedIn) {
      navItems.push(
        ...
        <ColumnLink key='reactions' icon='smile-o' text={intl.formatMessage(messages.reactions)} to='/reactions' />,
